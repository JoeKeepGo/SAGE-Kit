...
| external workflow bundle boundary recorded when used | `<yes/no/n/a>` | `<notes>` |
...
| Severity gate applied | `<yes/no>` | `<P0/P1 block; authority/false-green/approval-boundary/security-boundary/required-check-failure/source-authority/evidence-integrity P2 block; ordinary P2 may auto-fix or carry concerns; P3 does not block>` |
