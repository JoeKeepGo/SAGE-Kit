...
Use only when an explicit Heavy/formal profile needs a controller transfer.
...
Skipped/unavailable checks and non-blocking concerns:
Human gates / acceptance owner:
Next owner/action:
```
