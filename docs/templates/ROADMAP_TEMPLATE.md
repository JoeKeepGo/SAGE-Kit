...
`docs/templates/MILESTONE_ROADMAP_TEMPLATE.md`.

Prefer using `MILESTONE_ROADMAP_TEMPLATE.md` for new projects.
...
- Milestones should be small enough to review and verify.
