...
When external workflow bundle is used, record the selected skill name and the SAGE-Kit
boundary it served. A external workflow bundle completion signal is execution evidence, not
...
## Structured Record Status

Use this table only when the project selects structured task/evidence records.

| Task | Status | Required Levels | Project Check | Shared Resources | Evidence | Next Action |
|---|---|---|---|---|---|---|
