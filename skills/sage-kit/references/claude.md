...
| Packet, source, file boundary, and controller duties | `docs/agent/AGENT_HARNESS.md#sage-auth-010` | Dispatch the resolved authority and named launch-only delta; Coder packet file and command limits remain `SOFT` instructions unless a separate control covers a specific operation. |
