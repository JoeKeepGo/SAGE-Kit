...
`package-doc("docs/agent/SPEC_SOURCE_CONTRACT.md#sage-ctx-001")`. `legacy-markdown` continues to use the retained
...
- Runtime override: record any applicable override ID and status from
  `package-doc("docs/agent/CAPABILITY_ADAPTERS.md#sage-adp-007")`; otherwise use the runtime's
...
Admit Graph planning under `package-doc("docs/SAGE_CORE.md#sage-grf-001")`. Record the
...
`package-doc("docs/agent/WAVE_EXECUTION.md#sage-grf-002")`,
`package-doc("docs/agent/WAVE_EXECUTION.md#sage-grf-005")`, and
`package-doc("docs/agent/WAVE_EXECUTION.md#sage-grf-006")`.
...
condition in `package-doc("docs/agent/SESSION_ORCHESTRATION.md")` passes; otherwise run
Targeted Re-Review.
...
`package-doc("docs/agent/CAPABILITY_ADAPTERS.md#sage-adp-003")` when a phase, milestone, or
