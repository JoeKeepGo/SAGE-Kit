...
`package-doc("docs/agent/EXECUTION_ECONOMY.md")`. Use
`package-doc("docs/agent/CONTINUITY_PROTOCOL.md")` when a local limit requires
...
`package-doc("docs/agent/SPEC_SOURCE_CONTRACT.md#sage-ctx-001")`.
...
`package-doc("docs/agent/CAPABILITY_ADAPTERS.md#sage-adp-003")`. Apply any runtime-specific ban
...
- After corrective work, Final Review follows the Deterministic Closure or
  re-review selection contract in `package-doc("docs/agent/SESSION_ORCHESTRATION.md")`. Only
...
`package-doc("docs/agent/AGENT_HARNESS.md#sage-auth-010")`; this reference retains execution-
...
`package-doc("docs/agent/EXECUTION_ECONOMY.md#sage-loop-003")`, candidate binding at
...
`package-doc("docs/agent/EXECUTION_ECONOMY.md#sage-loop-006")` and `#sage-loop-008`; execution
...
`package-doc("docs/agent/EXECUTION_ECONOMY.md#sage-loop-008")`; this reference records the
...
Apply Graph admission from `package-doc("docs/SAGE_CORE.md#sage-grf-001")` and execution-shape
and active-change semantics from `package-doc("docs/agent/WAVE_EXECUTION.md#sage-grf-002")` and
`package-doc("docs/agent/WAVE_EXECUTION.md#sage-grf-006")`. This reference remains responsible
